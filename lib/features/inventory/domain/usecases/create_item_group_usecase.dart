...
class CreateItemGroupUseCase implements UseCase<void, ItemGroupEntity> {
  final InventorySetupRepository repository;

  CreateItemGroupUseCase(this.repository);

  @override
  Future<Either<Failure, void>> call(ItemGroupEntity params) async {
    try {
      final result = await repository.createItemGroup(params);
      return result.fold(
