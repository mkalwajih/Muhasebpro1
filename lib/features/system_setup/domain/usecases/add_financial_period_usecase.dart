...
class AddFinancialPeriodUseCase implements UseCase<void, FinancialPeriodEntity> {
  final FinancialPeriodsRepository repository;

  AddFinancialPeriodUseCase(this.repository);

  @override
  Future<Either<Failure, void>> call(FinancialPeriodEntity params) async {
    return await repository.addFinancialPeriod(params);
  }
}
