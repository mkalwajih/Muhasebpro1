...
class _CompanyInfoScreenState extends ConsumerState<CompanyInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(t.company.title),
        actions: [
          IconButton(
            icon: const Icon(Icons.add_business),
            tooltip: t.company.addNew,
              ...
              child: companiesAsync.when(
                data: (companies) {
                  if (companies.isEmpty) {
                    return Center(child: Text(t.company.empty, textAlign: TextAlign.center));
                  }
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  // Header Title
                  Text(
                    _selectedCompany == null ? t.company.addNew : '${t.common.edit}: ${_selectedCompany!.companyCode}',
                      ...
                      Column(
                        children: [
                          ...
                          TextButton.icon(
                            ...
                            label: Text(t.company.uploadLogo),
                          ),
                        ],
                      ),
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: t.company.commercialReg,
                            border: const OutlineInputBorder(),
                  ...
                  // Flags
                  SwitchListTile(
                    title: Text(t.company.mainCompany),
                    subtitle: Text(t.company.mainCompanyHint),
