...
class _CompanyInfoScreenState extends ConsumerState<CompanyInfoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(t.dashboard.inventory.master.setup.company.title),
        actions: [
          IconButton(
            icon: const Icon(Icons.add_business),
            tooltip: t.dashboard.inventory.master.setup.company.addNew,
              ...
              child: companiesAsync.when(
                data: (companies) {
                  if (companies.isEmpty) {
                    return Center(child: Text(t.dashboard.inventory.master.setup.company.empty, textAlign: TextAlign.center));
                  }
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  // Header Title
                  Text(
                    _selectedCompany == null ? t.dashboard.inventory.master.setup.company.addNew : '${t.common.edit}: ${_selectedCompany!.companyCode}',
                      ...
                      Column(
                        children: [
                          ...
                          TextButton.icon(
                            ...
                            label: Text(t.dashboard.inventory.master.setup.company.uploadLogo),
                          ),
                        ],
                      ),
                          ...
                          children: [
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: t.dashboard.inventory.master.setup.company.code,
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: t.dashboard.inventory.master.setup.company.nameEn,
                                border: const OutlineInputBorder(),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: t.dashboard.inventory.master.setup.company.nameAr,
                      border: const OutlineInputBorder(),
                    ...
                    children: [
                      Expanded(
                        child: allCountriesAsync.when(
                          data: (countries) => DropdownButtonFormField<int>(
                            value: _countryId,
                            decoration: InputDecoration(
                              labelText: t.dashboard.inventory.master.setup.geo.country,
                              border: const OutlineInputBorder(),
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: t.dashboard.inventory.master.setup.company.taxNumber,
                            border: const OutlineInputBorder(),
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: t.dashboard.inventory.master.setup.company.commercialReg,
                            border: const OutlineInputBorder(),
                  ...
                  // Flags
                  SwitchListTile(
                    title: Text(t.dashboard.inventory.master.setup.company.mainCompany),
                    subtitle: Text(t.dashboard.inventory.master.setup.company.mainCompanyHint),
