...
class _AddEditBranchDialogState extends ConsumerState<AddEditBranchDialog> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (_selectedCompanyId == null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(t.master.setup.branch.selectCompanyPrompt), backgroundColor: Theme.of(context).colorScheme.error),
        );
        return;
      }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(widget.branch == null ? t.master.setup.branch.addNew : t.master.setup.branch.editTitle),
      content: Form(
        key: _formKey,
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                decoration: InputDecoration(labelText: t.master.setup.branch.code),
                validator: (value) =>
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: t.master.setup.branch.nameEn),
                validator: (value) =>
                    (value == null || value.isEmpty) ? t.common.requiredField : null,
              ),
               const SizedBox(height: 8),
              TextFormField(
                ...
                decoration: InputDecoration(labelText: t.master.setup.branch.nameAr),
                validator: (value) =>
                    (value == null || value.isEmpty) ? t.common.requiredField : null,
              ),
               const SizedBox(height: 8),
              companiesAsyncValue.when(
                data: (companies) => DropdownButtonFormField<int>(
                  ...
                  decoration: InputDecoration(labelText: t.company.title),
              ...
              branchGroupsAsyncValue.when(
                data: (groups) => DropdownButtonFormField<int>(
                  ...
                  decoration: InputDecoration(labelText: t.master.setup.branch.group),
                  items: groups
               ...
               const SizedBox(height: 8),
              Tooltip(
                message: t.master.setup.branch.warehouseTooltip,
                child: DropdownButtonFormField<int>(
                  value: null,
                  decoration: InputDecoration(
                    labelText: t.master.setup.branch.defaultWarehouse,
