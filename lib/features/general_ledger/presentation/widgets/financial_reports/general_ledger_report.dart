...
class GeneralLedgerReport extends ConsumerStatefulWidget {
  const GeneralLedgerReport({super.key});

  @override
  ConsumerState<GeneralLedgerReport> createState() => _GeneralLedgerReportState();
}

class _GeneralLedgerReportState extends ConsumerState<GeneralLedgerReport> {
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        l10n.selectAccountToViewLedger,
